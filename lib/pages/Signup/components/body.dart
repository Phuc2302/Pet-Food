...
import 'package:flutter_catalog/pages/Signup/components/background.dart';
...
import 'package:flutter_catalog/widgets/login_widgets/rounded_input_field.dart';
import 'package:flutter_catalog/widgets/login_widgets/rounded_password_field.dart';
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedButton(
              text: "SIGNUP",
              press: () => Navigator.pushNamed(context, MyRoutes.homeRoute),
            ),
            SizedBox(height: size.height * 0.03),
